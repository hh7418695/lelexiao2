        ...
        <script>
            $(function () {
                ...
                $('form').on('submit', function (e) {
                    ...
                    $.post('<?php echo e(url('/do-install'), false); ?>', $(this).serialize())
                        .done(function (ret) {
                            if (ret === 'success') {
                                $('#error').hide();
...
<?php /**PATH /Users/vercetti/Project/lelexiao2/resources/views/common/install.blade.php ENDPATH**/ ?>